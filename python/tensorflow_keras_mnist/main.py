...
print(predictions)
prediction_num = np.argmax(predictions[0])
print(hand_written_number_names[prediction_num])

# 学習モデルの保存
# HDF5形式 ... Hierarchical Data Format. 拡張子は.h5. 階層化された大量で複雑なデータセットを取り扱えるフォーマット.
model.save('tensorflow-keras-mnist-model.h5')