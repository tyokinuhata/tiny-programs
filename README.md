...
|configmap_manifest|ConfigMapをマニフェストから生成するサンプル|
...
|chainer_mnist_inspec|ChainerとMNISTを用いた手書き数字認識(検証)のサンプル|
...
|numpy_itemsize|NumPyで要素毎のあ微斗数を取得するサンプル|
...
|return_none|暗黙のreturn None文のサンプル|
